...
- Now try out converting an app to ES6 modules
  ...
  - Follow the instructions in **main.js** and convert the code to use ES6 module syntax (`import`/`export`)
    - note that when you import the utils file into main.js, you need to use the file extension, and a leading period, meaning **./utils.js**, NOT just **./utils** (which is what VS Code defaults to)
