...
- Web Components - have not really taken off yet, but they are a [web standard](https://developer.mozilla.org/en-US/docs/Web/API/Web_Components), so they have there uses and it's likely that future web frameworks will leverage them in some way
  - [Web Components-1 - Intro to Web Components]([../notes/wc-1.md](https://github.com/tonethar/IGME-330-spring-2023/blob/main/notes/wc-1.md)
  - [Web Components-2 - Shadow DOM and HTML Templates]([../notes/wc-2.md)](https://github.com/tonethar/IGME-330-spring-2023/blob/main/notes/wc-2.md)
