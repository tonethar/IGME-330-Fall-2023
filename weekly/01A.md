...
- Generative AI
  - In this course, we will be utilizing these tools to research concepts
  - NOT for generating code that is copy/pasted verbatim and without thought or understanding on the part of the student
