...
- [2B Checkoff - adding ES6 moduels to **DoubleIt**](./02B.md#vi-2b-checkoff)
  ...
  - Note that you can export a symbol (function, class, or variable) right when you declare it ex. `export const doubleIt = num => num * 2;`
  - OR at the botton of the file like this: `export { doubleIt };`
